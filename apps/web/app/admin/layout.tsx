...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navLinks = [
    ...
    { href: '/admin/blog', label: 'Blog CMS', icon: '<path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/>' },
    { href: '/admin/slots', label: 'Availability', icon: '<rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/><path d="m9 16 2 2 4-4"/>' },
  ]
