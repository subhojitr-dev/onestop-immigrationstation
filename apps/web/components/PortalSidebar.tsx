...
const svgs: Record<string, string> = {
  ...
  team:           '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="16" y1="11" x2="22" y2="11"/>',
...
export default function PortalSidebar({ userName, userRole }: Props) {
  ...
  const mainNav = [
    ...
    ...(userRole === 'contact' ? [
      { id: 'team', href: '/dashboard/team', label: 'My Team' },
    ] : []),
    ...(userRole === 'sponsor' ? [
      { id: 'team', href: '/dashboard/team', label: 'Beneficiaries' },
    ] : []),
    ...(userRole === 'admin' ? [
