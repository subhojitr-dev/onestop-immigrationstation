      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.caseHeader}>
          ...
          <View style={styles.statusBadge}>
            <Text style={styles.statusText}>{caseData.status.replace('_', ' ').toUpperCase()}</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  topBar: { backgroundColor: Colors.navy, padding: Spacing.md, flexDirection: 'row', alignItems: 'center' },
  ...
  timelineDot: { width: 12, height: 12, borderRadius: 6, backgroundColor: Colors.gold, marginTop: 4, marginRight: Spacing.md },
